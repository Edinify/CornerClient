...
export const SEARCH_VALUES_ACTION_TYPES = {
  ...
  WAREHOUSE_SEARCH_VALUE:"WAREHOUSE_SEARCH_VALUE"
};
...
export const WAREHOUSE_FILTER_ACTION_TYPE={
  GET_WAREHOUSE_CATEGORY:"GET_WAREHOUSE_CATEGORY"
}
...
export const CATEGORY_ACTION_TYPE = {
  ...
  GET_BASE_CATEGORY: "GET_BASE_CATEGORY",
};
...
export const TABLES_USER_ACTION_TYPE = {
  GET_TABLES_USER: "GET_TABLES_USER",
  USER_TABLES_LOADING: "USER_TABLES_LOADING",
};

export const MENU_USER_ACTION_TYPE = {
  GET_MENU_USER: "GET_MENU_USER",
};
...
export const CHECK_ACTION_TYPE = {
  ...
  GET_USER_CHECK: "GET_USER_CHECK",
  GET_CHECK_LAST_PAGE: "GET_CHECK_LAST_PAGE",
  CHECK_LOADING: "CHECK_LOADING",
  UPDATE_USER_CHECK: "UPDATE_USER_CHECK",
  ADD_ORDER_ACTION: "ADD_ORDER_ACTION",
  ADD_SET_ACTION:"ADD_SET_ACTION",
  REMOVE_SET_ACTION:"REMOVE_SET_ACTION",
  REMOVE_ORDER_ACTION: "REMOVE_ORDER_ACTION",
  CREAT_USER_CHECK: "CREAT_USER_CHECK",
  RESET_USER_CHECK: "RESET_USER_CHECK",
  CHECK_USER_LOADING: "CHECK_USER_LOADING",
  CHECK_SUBMIT_LOADING: "CHECK_SUBMIT_LOADING",
};

export const SETS_ACTION_TYPE = {
  GET_SETS: "GET_SETS",
  GET_SETS_FOR_USER: "GET_SETS_FOR_USER",  
  CREATE_SETS: "CREATE_SETS",
  UPDATE_SETS: "UPDATE_SETS",
  DELETE_SETS: "DELETE_SETS",
  SETS_LOADING: "SETS_LOADING",
  GET_SETS_LAST_PAGE: "GET_SETS_LAST_PAGE",
  ADD_SET_PRODUCTS: "ADD_SET_PRODUCTS",
};

export const SETS_M0DAL_ACTION_TYPE = {
  GET_SETS_MODAL: "GET_SETS_MODAL",
  SETS_OPEN_MODAL: "SETS_OPEN_MODAL",
  SETS_MODAL_LOADING: "SETS_MODAL_LOADING",
};
